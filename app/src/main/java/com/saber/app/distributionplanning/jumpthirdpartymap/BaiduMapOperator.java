...
public class BaiduMapOperator extends IMapOperator {
    ...
    private String getNavigationUrl(NavParamEntity entity) {
        ...
        if (entity.getFrom() != null) {
            sb.append("origin=").append(entity.getFrom().getLatitude()).append(",").append(entity.getFrom().getLongitude()).append("&");
        }
        sb.append("destination=").append(entity.getTo().getLatitude()).append(",").append(entity.getTo().getLongitude());
